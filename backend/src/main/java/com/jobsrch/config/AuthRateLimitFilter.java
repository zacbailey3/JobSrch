...
public class AuthRateLimitFilter extends OncePerRequestFilter {
    ...
    private static final List<Rule> RULES = List.of(
            ...
            new Rule("account-reauth", "POST", "/api/account/reauth/password", 10, false),
            new Rule("password-change", "PUT", "/api/account/password", 5, false),
            new Rule("email-change-request", "POST", "/api/account/email-change/request", 5, false),
            new Rule("email-change-confirm", "POST", "/api/account/email-change/confirm", 10, false),
            new Rule("account-delete", "DELETE", "/api/account", 3, false),
